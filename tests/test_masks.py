...
def test_get_mask_card_number(valid_card_number, masked_card_number) -> None:
...
def test_get_mask_card_number_incorrect(invalid_number_long, invalid_number_short, invalid_number_empty) -> None:
...
def test_get_mask_card_number_type(invalid_number_symbol) -> None:
    with pytest.raises(TypeError):
        get_mask_card_number(invalid_number_symbol)


# Тестирование правильности маскирования номера счета.
def test_get_mask_account(valid_account_number, valid_masked_account_number) -> None:
    assert get_mask_account(valid_account_number) == valid_masked_account_number


# Проверка работы функции с различными форматами и длинами номеров счетов.
def test_get_mask_account_incorrect(invalid_number_short, invalid_number_long, invalid_number_empty) -> None:
...
def test_get_mask_account_type(invalid_number_symbol) -> None:
    with pytest.raises(TypeError):
